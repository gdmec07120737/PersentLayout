...
package com.vince.persentlayout.support;
...
import com.vince.persentlayout.R;
 ...
 * method that you implemented for { android.support.percent.PercentLayoutHelper.PercentLayoutParams} interface.
 * <li> Override
...
public class PercentLayoutHelper {
        ...
        for (int i = 0, N = mHost.getChildCount(); i < N; i++) {
            ...
            if (params instanceof PercentLayoutParams) {
                ...
                if (info != null) {
                    ...
                    //支持padding  zhengvince 2015-8-12
    ...
    private void supportPadding(int widthHint, int heightHint, View view, PercentLayoutInfo info) {
        ...
        PercentLayoutInfo.PercentVal leftPaddingPercent = info.leftPaddingPercent;
        PercentLayoutInfo.PercentVal topPaddingPercent = info.topPaddingPercent;
        PercentLayoutInfo.PercentVal rightPaddingPercent = info.rightPaddingPercent;
        PercentLayoutInfo.PercentVal bottomPaddingPercent = info.bottomPaddingPercent;

        Log.d("percentPadding","----------"+view+"----------------");

        Log.d("percentPadding", "  widthHint = " + widthHint + "  ");
        Log.d("percentPadding", "  heightHint = " + heightHint + "  ");


        if (leftPaddingPercent != null) {
            int base = leftPaddingPercent.isBaseWidth ? widthHint : heightHint;
            leftPadding = (int) (base * leftPaddingPercent.percent);
            Log.d( "percentPadding","  leftPaddingPercent = " + leftPaddingPercent.percent + "  ");
        }
        if (topPaddingPercent != null) {
            int base = topPaddingPercent.isBaseWidth ? widthHint : heightHint;
            topPadding = (int) (base * topPaddingPercent.percent);
            Log.d("percentPadding","  topPaddingPercent = " + topPaddingPercent.percent + "  ");

        }
        if (rightPaddingPercent != null) {
            int base = rightPaddingPercent.isBaseWidth ? widthHint : heightHint;
            rightPadding = (int) (base * rightPaddingPercent.percent);
            Log.d("percentPadding","  rightPaddingPercent = " + rightPaddingPercent.percent + "  ");

        }
        if (bottomPaddingPercent != null) {
            int base = bottomPaddingPercent.isBaseWidth ? widthHint : heightHint;
            bottomPadding = (int) (base * bottomPaddingPercent.percent);
            Log.d("percentPadding", "  bottomPaddingPercent = " + bottomPaddingPercent.percent + "  ");

        }
        if (leftPaddingPercent != null || topPaddingPercent != null || rightPaddingPercent != null || bottomPaddingPercent != null) {
            view.setPadding(leftPadding, topPadding, rightPadding, bottomPadding);

            Log.d( "percentPadding","  leftPadding = " + leftPadding + "  ");
            Log.d("percentPadding","  topPadding = " + topPadding + "  ");
            Log.d("percentPadding","  rightPadding = " + rightPadding + "  ");
            Log.d("percentPadding","  bottomPadding = " + bottomPadding + "  ");
    ...
    public static PercentLayoutInfo getPercentLayoutInfo(Context context,
        ...
        //支持padding  zhengvince 2015-8-12
        sizeStr = array.getString(R.styleable.PercentLayout_Layout_layout_paddingPercent);
        percentVal = getPercentVal(sizeStr, false);
        if (percentVal != null) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
                Log.v(TAG, "percent padding: " + percentVal.percent);
            }
            info = checkForInfoExists(info);
            info.leftPaddingPercent = getPercentVal(sizeStr, true);
            info.topPaddingPercent = getPercentVal(sizeStr, false);
            info.rightPaddingPercent = getPercentVal(sizeStr, true);
            info.bottomPaddingPercent = getPercentVal(sizeStr, false);

        }

        sizeStr = array.getString(R.styleable.PercentLayout_Layout_layout_paddingLeftPercent);
        percentVal = getPercentVal(sizeStr, true);
        if (percentVal != null) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
                Log.v(TAG, "percent left padding: " + percentVal.percent);
            }
            info = checkForInfoExists(info);
            info.leftPaddingPercent = percentVal;
        }

        //  value = array.getFraction(R.styleable.PercentLayout_Layout_layout_paddingTopPercent, 1, 1,
        //        -1f);
        sizeStr = array.getString(R.styleable.PercentLayout_Layout_layout_paddingTopPercent);
        percentVal = getPercentVal(sizeStr, false);
        if (percentVal != null) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
                Log.v(TAG, "percent top padding: " + percentVal.percent);
            }
            info = checkForInfoExists(info);
            info.topPaddingPercent = percentVal;
        }
        // value = array.getFraction(R.styleable.PercentLayout_Layout_layout_paddingRightPercent, 1, 1,
        //       -1f);
        sizeStr = array.getString(R.styleable.PercentLayout_Layout_layout_paddingRightPercent);
        percentVal = getPercentVal(sizeStr, true);
        if (percentVal != null) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
                Log.v(TAG, "percent right padding: " + percentVal.percent);
            }
            info = checkForInfoExists(info);
            info.rightPaddingPercent = percentVal;
        }
        //value = array.getFraction(R.styleable.PercentLayout_Layout_layout_paddingBottomPercent, 1, 1,
        //  -1f);
        sizeStr = array.getString(R.styleable.PercentLayout_Layout_layout_paddingBottomPercent);
        percentVal = getPercentVal(sizeStr, false);
        if (percentVal != null) {
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
                Log.v(TAG, "percent bottom padding: " + percentVal.percent);
            }
            info = checkForInfoExists(info);
            info.bottomPaddingPercent = percentVal;
        }
    ...
    public static class PercentLayoutInfo {
        ...
        //1.0.5 支持padding  zhengvince 2015-8-12

        public PercentVal leftPaddingPercent;

        public PercentVal topPaddingPercent;

        public PercentVal rightPaddingPercent;

        public PercentVal bottomPaddingPercent;
